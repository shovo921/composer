...
class InstallRepository
{
    ...
    {
        if (empty(request('access_code')) || empty(request('envato_email'))) {
            Log::info('Using default license');
            Storage::put('.access_code', 'DEFAULT');
            Storage::put('.account_email', 'DEFAULT');
        ...
        Storage::put('.temp_app_installed', 'sdsdsdsd' );
        Storage::put('.access_code', 'sdsdsdsdsdsd' );
